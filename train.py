...
if __name__ == '__main__':
    ...
    # model = YOLO(r'ultralytics/cfg/models/11/yolo11-Prism/yolo11-EfficientNetV2-Prism-v2.yaml')
    model = YOLO(r'ultralytics/cfg/models/11/yolo11-Zenith/yolo11-Zenith.yaml')
